        ...
        <section className="bg-gradient-to-r from-blue-600 to-purple-700 text-white py-20">
          <div className="max-w-6xl mx-auto px-4 text-center">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 max-w-2xl mx-auto">
              <div className="w-48 h-48 mx-auto mb-6 bg-gradient-to-br from-blue-200 to-purple-200 rounded-full flex items-center justify-center overflow-hidden">
                <Image
                  src="/aiimage.webp" 
                  alt="Future IT Professional"
                  width={192} 
                  height={192}
